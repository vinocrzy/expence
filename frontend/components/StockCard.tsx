...
export default function StockCard({ holding, onClick }: StockCardProps) {
  ...
  return (
    <div
      className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden hover:border-zinc-700 transition cursor-pointer"
      onClick={onClick}
    >
      {/* Main Content */}
      <div className="p-4">
        ...
        {/* Expanded Details */}
        {isExpanded && (
          <div className="mt-4 pt-4 border-t border-zinc-800 space-y-3 animate-in slide-in-from-top-2">
            {/* Investment Details */}
