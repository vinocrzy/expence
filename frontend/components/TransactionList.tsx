...
export default function TransactionList({ 
  ...
  return (
    <div className="space-y-3 pb-24 md:space-y-0 md:pb-0 md:divide-y md:divide-gray-800">
        {transactions.map((t) => (
            <div key={t.id}>
                ...
                {/* Desktop View: Existing Row Layout (Enhanced) */}
                <div className="hidden md:flex flex-col group hover:bg-gray-800/30 transition-colors">
                    <div 
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                                <div className="font-bold text-white mb-0.5 text-base line-clamp-1">{t.description || 'No description'}</div>
                                <div className="flex items-center gap-2 text-xs text-gray-400 mt-0.5">
                                    ...
                                    <span className="truncate max-w-[200px]">{accountMap[t.accountId]?.name}</span>
                                    <span className="text-gray-600">•</span>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                    ...
                                    className="p-2 text-gray-500 hover:text-purple-400 transition-all active:scale-95 bg-gray-800 rounded-lg"
                                ...
                                <button
                                    ...
                                    className="p-2 text-gray-500 hover:text-red-400 transition-all active:scale-95 bg-gray-800 rounded-lg"
                    ...
                    {/* Expanded Split Details (Desktop) */}
                    {t.isSplit && expandedSplits.has(t.id) && (
                        <div className="bg-gray-800/40 border-t border-gray-800 px-4 py-3 mx-4 mb-2 rounded-b-lg animate-in slide-in-from-top-2 fade-in duration-200">
                            <p className="text-xs font-bold text-gray-500 uppercase mb-2 pl-16">Split Breakdown</p>
