        ...
        {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loans.map(loan => {
                    ...
                    return (
                        <div key={loan.id} className="block group relative">
                            <Link href={`/loans/${loan.id}`} className="block h-full">
                                <div className="bg-gray-800 border border-gray-700/50 rounded-2xl p-6 hover:border-purple-500/50 transition-all shadow-lg hover:shadow-purple-500/10 h-full flex flex-col">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 border-t border-gray-700/50 pt-4 mb-4">
