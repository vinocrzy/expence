...
INSERT INTO "new_Account" ("balance", "createdAt", "currency", "householdId", "id", "isArchived", "meta", "name", "type", "userId") SELECT "balance", "createdAt", "currency", "householdId", "id", "isArchived", "meta", "name", "type", "userId" FROM "Account";
DROP TABLE "Account";
...
INSERT INTO "new_Category" ("color", "householdId", "id", "kind", "name") SELECT "color", "householdId", "id", "kind", "name" FROM "Category";
DROP TABLE "Category";
...
INSERT INTO "new_Transaction" ("accountId", "amount", "budgetId", "categoryId", "counterpartyId", "createdAt", "createdBy", "currency", "date", "description", "id", "linkedTransactionId", "recurringRuleId", "subCategory", "tags", "type") SELECT "accountId", "amount", "budgetId", "categoryId", "counterpartyId", "createdAt", "createdBy", "currency", "date", "description", "id", "linkedTransactionId", "recurringRuleId", "subCategory", "tags", "type" FROM "Transaction";
